...
/**
 *
 * Класс меню. Содержит информацию о продуктах и стоимости кафе.
 * Для инициализации меню достаточно создать экземпляр класса.
 *  Цены на товар инициализируются при создании экземпляра класса.
 *
 */
